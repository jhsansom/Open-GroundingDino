...
WEIGHTS="./logs_mixture/checkpoint0000.pth"
python eval.py --real --spatial --weights=$WEIGHTS # refcoco spatial
python eval.py --real --weights=$WEIGHTS # refcoco nonspatial
python eval.py --weights=$WEIGHTS # synthetic validation

# Epoch 1 (after 2 epochs of training)
WEIGHTS="./logs_mixture/checkpoint0001.pth"
python eval.py --real --spatial --weights=$WEIGHTS # refcoco spatial
python eval.py --real --weights=$WEIGHTS # refcoco nonspatial
python eval.py --weights=$WEIGHTS # synthetic validation

# Epoch 2 (after 3 epochs of training)
WEIGHTS="./logs_mixture/checkpoint0002.pth"
python eval.py --real --spatial --weights=$WEIGHTS # refcoco spatial
python eval.py --real --weights=$WEIGHTS # refcoco nonspatial
python eval.py --weights=$WEIGHTS # synthetic validation

# Epoch 3 (after 4 epochs of training)
WEIGHTS="./logs_mixture/checkpoint0003.pth"
python eval.py --real --spatial --weights=$WEIGHTS # refcoco spatial
python eval.py --real --weights=$WEIGHTS # refcoco nonspatial
python eval.py --weights=$WEIGHTS # synthetic validation

# Epoch 4 (after 5 epochs of training)
WEIGHTS="./logs_mixture/checkpoint0004.pth"
python eval.py --real --spatial --weights=$WEIGHTS # refcoco spatial
python eval.py --real --weights=$WEIGHTS # refcoco nonspatial
python eval.py --weights=$WEIGHTS # synthetic validation

# Epoch 5 (after 6 epochs of training)
WEIGHTS="./logs_mixture/checkpoint0005.pth"
python eval.py --real --spatial --weights=$WEIGHTS # refcoco spatial
python eval.py --real --weights=$WEIGHTS # refcoco nonspatial
python eval.py --weights=$WEIGHTS # synthetic validation

# Epoch 6 (after 7 epochs of training)
WEIGHTS="./logs_mixture/checkpoint0006.pth"
python eval.py --real --spatial --weights=$WEIGHTS # refcoco spatial
python eval.py --real --weights=$WEIGHTS # refcoco nonspatial
python eval.py --weights=$WEIGHTS # synthetic validation